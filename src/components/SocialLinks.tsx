...
const SocialLinks = () => {
  return (
    <div className="gap-x-4 social-links items-center flex">
      <a href="https://twitter.com/BuildOnCrossX" target="_blank" rel="noreferrer">
        <img src={iconX} alt="CrossX Game" className="w-12 h-12" />
      </a>
      {/* <a href="https://t.me/crossxroblox" target="_blank" rel="noreferrer">
        <img src={iconTelegram} alt="Telegram" className="w-12 h-12" />
      </a> */}
      <a href="https://discord.gg/SEA7gzfe" target="_blank" rel="noreferrer">
        <img src={iconDiscord} alt="Discord" className="w-12 h-12" />
      </a>
    </div>
  )
} 
